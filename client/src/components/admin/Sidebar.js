  ...
  return (
    <div className={classes.root}>
      ...
      >
        ...
        <Divider />
        <NavLink to='/admin/addFaculty' exact className={classes.navLink}>
          <List className={classes.listItem}>
            <ListItem button className={classes.listItemButton}>
              <ListItemIcon>
                <AddBoxIcon />
        ...
        <Divider />
        <NavLink to='/admin/addStudent' exact className={classes.navLink}>
          <List className={classes.listItem}>
            <ListItem button className={classes.listItemButton}>
              <ListItemIcon>
                <GroupAddIcon />
        ...
        <NavLink to='/admin/addSubject' exact className={classes.navLink}>
          <List className={classes.listItem}>
            <ListItem button className={classes.listItemButton}>
              <ListItemIcon>
                <PostAddIcon />
        ...
        <Divider />
        <NavLink to='/admin/ourFaculties' exact className={classes.navLink}>
          <List className={classes.listItem}>
            <ListItem button className={classes.listItemButton}>
              <ListItemIcon>
        ...
        <Divider />
        <NavLink to='/admin/ourStudents' exact className={classes.navLink}>
          <List className={classes.listItem}>
            <ListItem button className={classes.listItemButton}>
              <ListItemIcon>
                <PeopleIcon />
        ...
        <Divider />
        <NavLink to='/admin/subjectsList' exact className={classes.navLink}>
          <List className={classes.listItem}>
            <ListItem button className={classes.listItemButton}>
              <ListItemIcon>
                <ListIcon />
